...
interface CarEditFormProps {
  ...
  onSelectModel: (e: React.ChangeEvent<HTMLInputElement>) => void;
    ...
    <div className="w-full h-full flex flex-col">
      ...
      >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <Field label="Rating count">
              <input
                ...
                onChange={(e) =>
                  setField("rating_count", Number(e.target.value))
                }
                className={inputClass}
              />
            </Field>
        ...
        <div className="pb-5">
          ...
          <label
            htmlFor={`car-model-${uniqueId}`}
            className="flex items-center gap-4 bg-[#1C2126] border border-white/5 rounded-xl p-3 cursor-pointer hover:border-white/10 transition-colors"
          >
            <div className="w-14 h-14 rounded-lg bg-[#262C33] flex items-center justify-center text-[#8B9299]">
              3D
            </div>
